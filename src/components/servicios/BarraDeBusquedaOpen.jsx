  ...
  return (
    ...
    <div className="2/5">
      ...
      {/* Quiero que mi barra de busqueda me permita filtrar por categoria */}
          ...
          <button className="bg-primary-300 text-secondary-100 border-r border-gray-200 rounded-l-md py-2 shadow-md px-4 hover:bg-primary-200">Programacion</button>
          ...
          <button className="bg-primary-300 text-secondary-100 py-2 border-r border-gray-200 shadow-md px-4 hover:bg-primary-200">Redes</button>
          <button className="bg-primary-300 text-secondary-100 py-2 border-r border-gray-200 shadow-md px-4 hover:bg-primary-200">Hardware</button>
          <button className="bg-primary-300 text-secondary-100 rounded-r-md py-2 shadow-md px-4 hover:bg-primary-200">Software</button>   
        </div>
</div>
  );
};
