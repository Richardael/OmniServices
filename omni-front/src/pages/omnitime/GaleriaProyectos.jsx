  ...
  return (
    ...
    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
      <thead class="bg-gray-50">
        <tr>
          <th scope="col" class="px-6 py-4 font-medium text-gray-900">Nombre de Proyecto</th>
          <th scope="col" class="px-6 py-4 font-medium text-gray-900">Cliente</th>
          <th scope="col" class="px-6 py-4 font-medium text-gray-900">Actividades</th>
      ...
      <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        ...
        >
          <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
            ...
            <div class="text-sm">
              <div class="font-medium text-gray-700">{proyecto.nombre_proyecto}</div>
